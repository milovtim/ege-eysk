!function (a) {
  ...
  var b = a.GreenSockGlobals || a,
      ...
      g = domDocument.defaultView ? domDocument.defaultView.getComputedStyle : function () {},
      h = /([A-Z])/g,
      i = function (a, b, c, d) {
        var e;
      ...
      k = function (a) {
        ...
        for (d = 0; c > d; d++)if (e = a[d], j(e))for (f = e.length, f = 0; f < e.length; f++)b.push(e[f]); else b.push(e);
        return b
      },
      l = ")eefec303079ad17405c",
      m = /(?:<br>|<br\/>|<br \/>)/gi,
      n = domDocument.all && !domDocument.addEventListener,
      ...
      constructor = d.SplitText = b.SplitText = function (b, c) {
        if ("string" == typeof b && (b = constructor.selector(b)), !b)throw"cannot split a null element.";
      ...
      u = function (a, b, c, d, h) {
        ...
        if (n || r)for (M = 0; D > M; M++)Q = P[M], K = Q.parentNode === a, (K || r || q && !o) && (R = Q.offsetTop, n && K && R !== t && "BR" !== Q.nodeName && (J = [], n.push(J), t = R), r && (Q._x = Q.offsetLeft, Q._y = R, Q._w = Q.offsetWidth, Q._h = Q.offsetHeight), n && (o !== K && q || (J.push(Q), Q._x -= v), K && M && (P[M - 1]._wordEnd = !0)));
        for (M = 0; D > M; M++)Q = P[M], K = Q.parentNode === a, "BR" !== Q.nodeName ? (r && (T = Q.style, o || K || (Q._x += Q.parentNode._x, Q._y += Q.parentNode._y), T.left = Q._x + "px", T.top = Q._y + "px", T.position = "absolute", T.display = "block", T.width = Q._w + 1 + "px", T.height = Q._h + "px"), o ? K ? d.push(Q) : q && c.push(Q) : K ? (a.removeChild(Q), P.splice(M--, 1), D--) : !K && q && (R = !n && !r && Q.nextSibling, a.appendChild(Q), R || a.appendChild(domDocument.createTextNode(" ")), c.push(Q))) : n || r ? (a.removeChild(Q), P.splice(M--, 1), D--) : o || a.appendChild(Q);
        if (n) {
          for (r && (S = domDocument.createElement("div"), a.appendChild(S), U = S.offsetWidth + "px", R = S.offsetParent === a ? 0 : a.offsetLeft, a.removeChild(S)), T = a.style.cssText, a.style.cssText = "display:none;"; a.firstChild;)a.removeChild(a.firstChild);
          for (V = !r || !o && !q, M = 0; M < n.length; M++) {
            for (J = n[M], S = domDocument.createElement("div"), S.style.cssText = "display:block;text-align:" + A + ";position:" + (r ? "absolute;" : "relative;"), I && (S.className = I + (H ? M + 1 : "")), h.push(S), D = J.length, N = 0; D > N; N++)"BR" !== J[N].nodeName && (Q = J[N], S.appendChild(Q), V && (Q._wordEnd || o) && S.appendChild(domDocument.createTextNode(" ")), r && (0 === N && (S.style.top = Q._y + "px", S.style.left = v + R + "px"), Q.style.top = "0px", R && (Q.style.left = Q._x - R + "px")));
      ...
      constructor.source = "greensock.com",
      constructor.selector = a.$ || a.jQuery || function (b) {
        return a.$ ? (constructor.selector = a.$, a.$(b)) : domDocument ? domDocument.getElementById("#" === b.charAt(0) ? b.substr(1) : b) : b
      }
}(window || {});